...
class Transaksi extends CI_Controller
{
  ...
  public function transaksi_baru()
  {
    ...
    //mobil merk
    $this->data["mobil"] = $this->Mobil_model->get_mobil_status();
  ...
  public function transaksi_baru_proses()
  {
    ...
    if ($this->form_validation->run() == FALSE) {
      ...
      $data = array(
        ...
        "transaksi_pelanggan"   => $this->input->post('pelanggan'),
  ...
  {
    $this->form_validation->set_rules('tgl_dikembalikan', 'tgl_dikembalikan', 'required');
    $this->form_validation->set_message('required', '{field} wajib di isi');
    $this->form_validation->set_error_delimiters('<div class="alert alert-danger">', '</div>');
