...
<head>
  ...
  <!-- Datatables CSS -->
  <link rel="stylesheet" href="<?php echo base_url('asset/datatables/dataTables.bootstrap4.min.css') ?>" type="text/css">
  <!-- Datepicker -->
  <link rel="stylesheet" href="<?php echo base_url('asset/datepicker/css/datepicker.css') ?>" type="text/css">
  <!-- Login CSS -->
