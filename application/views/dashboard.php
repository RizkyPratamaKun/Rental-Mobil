...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-lg-3">
      <div class="border mb-3">
        <div class="header-jumlah-pelanggan header font-weight-bold">
          <i class="fa fa-user" aria-hidden="true"></i>
          <span class="float-right">Jumlah pelanggan</span>
          <span class="float-right">
            <?php echo $jumlah_pelanggan; ?>
          </span>
        </div>
        <div class="card-body-jumlah-pelanggan card-body font-weight-bold">
          <a href="<?php echo base_url('pelanggan') ?>" class="btn btn-jumlah-pelanggan">
            <i class="fa fa-search" aria-hidden="true"></i>&nbsp;View Details
          </a>
        </div>
      </div>
  ...
  <div class="row">
    ...
    <div class="col-lg-3">
      <div class="card bg-light mb-3">
        <div class="card-header">
          <i class="fa fa-user" aria-hidden="true">&nbsp;pelanggan</i>
        </div>
        <div class="card-body">
          <table class="table">
            <tbody>
              <?php
              foreach ($pelanggan_baru as $pelanggan) {
                echo "<tr>";
                echo "<td>$pelanggan->pelanggan_nama</td>";
                echo "<td><span class='badge badge-pill badge-secondary'>$pelanggan->pelanggan_jk</span></td>";
                echo "</tr>";
              }
              ?>
            </tbody>
            <tfooter>
              <tr>
                <td colspan="2">
                  <a href="<?php echo base_url('pelanggan') ?>" class="btn btn-primary mt-3 float-right">
                    <i class="fa fa-search" aria-hidden="true"></i>&nbsp;View All
                  </a>
                </td>
              </tr>
