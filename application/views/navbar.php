...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <a class="navbar-brand" href="<?php echo base_url('dashboard') ?>">Kedan Trans & Tour</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <!-- Data pelanggan -->
      <li class="nav-item active">
        <a class="nav-link" href="<?php echo base_url('pelanggan') ?>"><i class="fa fa-user" aria-hidden="true"></i>&nbsp;Data pelanggan</a>
      </li>
      <!-- Data Transaksi -->
      <li class="nav-item active">
