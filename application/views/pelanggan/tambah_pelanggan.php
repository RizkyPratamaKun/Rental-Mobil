...
<div class="container">
  <div class="row">
    <div class="col-lg-12">
      ...
      <br>
      <h4 class="text-uppercase">Tambah pelanggan</h4>
      <hr>
      <form action="<?php echo base_url('pelanggan/tambah_pelanggan_proses') ?>" method="post" enctype="application/x-www-form-urlencoded">
        <!-- Nama pelanggan -->
